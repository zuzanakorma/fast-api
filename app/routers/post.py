...
def get_posts(db: Session = Depends(get_db), 
    ...
    # join operation did not work =>pydantic.error_wrappers.ValidationError
...
def get_post(id: int, db: Session = Depends(get_db), 
    ...
    # instead of .all, query only first instance, no need to check all DB
    if not post:
...
# 204 do not return any data back!!!
